...
export const NeutralEmotion = () => {
  ...
  const moods = ["Blank", "Apathetic", "Detached", "Good", "Indifferent","Okay"];
      ...
      <div className="h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 via-pink-100 to-yellow-100">
        ...
        <div className="min-w-5xl h-[600px] bg-transparent absolute rounded-2xl shadow-xl p-8 text-center border border-white">
          ...
          <div className="text-[#3E4352]">
            <p className="text-4xl font-bold mt-[61px]">Neutrality is a complex emotion</p>
          ...
          <div className="mt-2">
            <img src="./Neutral.png" alt="Angry Emoji" className="w-[170px] h-[170px] mx-auto" />
          </div>
          ...
          <div className="w-[480px] mx-auto ">
           ...
           <input
            ...
            [&::-webkit-slider-thumb]:bg-[#86FFD1]
            [&::-webkit-slider-thumb]:shadow-md
            [&::-webkit-slider-thumb]:cursor-pointer
            [&::-moz-range-thumb]:appearance-none"
            style={{
                background: `linear-gradient(to right, #15C5D5 ${angerLevel}%, #f3f4f6 ${angerLevel}%)`
            }}
          ...
          <p className="mt-[30px] w-1/2 text-2xl font-semibold text-[#3E4352]">
            What stage is your neutrality in?
          </p>
